...
export const MOCK_VAULTS = [
  { id: 1, name: "USDC Stable Pool", network: "Avalanche", tvl: 1250000, lockup: 7, apy: 5.2, asset: "USDC", status: ROUND_STATUS.ACTIVE, strategy: "Stable Yield", lastActivity: new Date(Date.now() - 2 * 60 * 60 * 1000) },
  { id: 2, name: "XLM Drip Vault", network: "Stellar", tvl: 450000, lockup: 0, apy: 3.8, asset: "XLM", status: ROUND_STATUS.PENDING, strategy: "Flexible Drip", lastActivity: new Date(Date.now() - 24 * 60 * 60 * 1000) },
  { id: 3, name: "ETH Growth Pool", network: "Avalanche", tvl: 8900000, lockup: 30, apy: 8.5, asset: "ETH", status: ROUND_STATUS.ACTIVE, strategy: "Growth", lastActivity: new Date(Date.now() - 1 * 60 * 60 * 1000) },
  { id: 4, name: "SOL Yield Max", network: "Solana", tvl: 2100000, lockup: 14, apy: 12.4, asset: "SOL", status: ROUND_STATUS.COMPLETED, strategy: "High Yield", lastActivity: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000) },
  { id: 5, name: "USDT Liquidity", network: "Avalanche", tvl: 3400000, lockup: 0, apy: 4.5, asset: "USDT", status: ROUND_STATUS.ACTIVE, strategy: "Stable Yield", lastActivity: new Date(Date.now() - 12 * 60 * 60 * 1000) },
  { id: 6, name: "BTC Reserve", network: "Stellar", tvl: 15600000, lockup: 90, apy: 10.1, asset: "BTC", status: ROUND_STATUS.PENDING, strategy: "Conservative", lastActivity: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000) },
];
